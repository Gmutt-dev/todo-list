...
// It might be time to start having a look at react, svelte or vue
// to make dom manipulation much less painful
export function loginButtonHandler(e) {
  ...
  modal.appendChild(
    createHTMLElement("p", {
      textContent:
        "IMPORTANT! - passwords and user content is not protected/encrypted.  However, all data remains ONLY on your device.  Please don't include any sensitive information anywhere in the app.",
      className: "warning",
    })
  );
...
export function registerButtonHandler(e) {
  ...
  modal.appendChild(
    createHTMLElement("p", {
      textContent:
        "Please enter your requested username and password and click submit.",
    })
  );
